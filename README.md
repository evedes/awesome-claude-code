...
- [spec-writer.md](agents/spec-writer.md): Guidelines for writing clear, testable specifications for LLM-based agents.
...
- [2025-09-29 - Engineering at Anthropic - Building agents with the Claude Agent SDK](https://www.anthropic.com/engineering/building-agents-with-the-claude-agent-sdk)
- [2024-12-19 - Engineering at Anthropic - Building effective agents](https://www.anthropic.com/engineering/building-effective-agents)
